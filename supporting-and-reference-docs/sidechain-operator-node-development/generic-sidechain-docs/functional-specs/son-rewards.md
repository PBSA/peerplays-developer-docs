...
7. If there are 13 active SONs, and each SON sent 3 heartbeats before next payout time,\
   You can find below snippet in the log during the chain maintenance,\
   pay 769 to 2.24.0 for 3 transactions signed\
   total txs = 13 x 3 = 39.\
   so pay for each SON -> (3/39)x10000 = 769
